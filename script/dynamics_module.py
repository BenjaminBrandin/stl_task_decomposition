...
def create_box_constraint_function(bounds: List[Tuple[float,float]])-> Tuple[np.ndarray,np.ndarray,np.ndarray] :
    """
...
def create_rectangular_constraint_function(bounds: List[Tuple[float, float]]) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
